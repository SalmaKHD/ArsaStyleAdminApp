...
fun ArsaRatingBar(
    ...
    val image = ImageBitmap.imageResource(id = R.drawable.ic_rating_empty)
    val imageFull = ImageBitmap.imageResource(id = R.drawable.ic_rating_full)
...
fun RatingBarPreview() {
    Surface {
        ArsaStyleAdminTheme {
            ArsaRatingBar(rating = 1.5f, spaceBetween = 4.dp)
        }
    }
}